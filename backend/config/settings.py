...
SECRET_KEY = 'django-insecure-*#_$+1jr(rvl!yswo32vh^8)nsopp-j-fhu0$x3r&7m+jkgyyu'
...
# API hardening defaults for local testing.
API_RATE_LIMIT_ENABLED = os.getenv('API_RATE_LIMIT_ENABLED', 'true').lower() == 'true'
API_THROTTLE_ANON_RATE = os.getenv('API_THROTTLE_ANON_RATE', '120/min')
...
REST_FRAMEWORK = {
    ...
    ] if API_RATE_LIMIT_ENABLED else [],
